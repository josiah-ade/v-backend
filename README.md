...
<p align="center">
  <a href="https://github.com/vndevteam/seamless/actions/workflows/ci.yml" target="_blank"><img src="https://github.com/vndevteam/seamless/actions/workflows/ci.yml/badge.svg" alt="Build & run test passing" /></a>
...
Demo: <https://seamless-diuf.onrender.com/api-docs>

## Getting started

```bash
# Clone the repository
git clone https://github.com/vndevteam/seamless.git
...
- [x] Fastify support. (Checkout the [`feature.fastify`](https://github.com/vndevteam/seamless/tree/feature.fastify) branch)
...
- [Brocoders NestJS Boilerplate](https://github.com/brocoders/seamless)

## Support

[Discuss on Github](https://github.com/vndevteam/seamless/discussions)
